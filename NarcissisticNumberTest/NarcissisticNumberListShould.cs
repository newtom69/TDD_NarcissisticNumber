...
namespace NarcissisticNumberDojoTest
{
    public class NarcissisticNumberListShould
    {
        ...
        {
            Assert.Equal(new List<int> { 1, 2, 3, 4, 5, 6, 7, 8, 9, 153, 370 }, NarcissisticNumber.NarcissisticNumberList(370));
        }

        [Fact]
        public void Return_good_list_when_93084()
        {
            Assert.Equal(new List<int> { 1, 2, 3, 4, 5, 6, 7, 8, 9, 153, 370, 371, 407, 1634, 8208, 9474, 54748, 92727, 93084 }, NarcissisticNumber.NarcissisticNumberList(93084));
        }
    }
}
